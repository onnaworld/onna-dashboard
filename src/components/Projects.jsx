  ...
  if (selectedProject) return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 22 }}>
        ...
        {saveStatus && <span title={saveStatus === "error" ? saveErrorMsg : undefined} style={{ marginLeft: "auto", fontSize: 11, color: saveStatus === "saving" ? T.muted : saveStatus === "error" ? "#d32f2f" : "#34c759", fontWeight: 500, opacity: 0.85, transition: "opacity 0.3s", display: "flex", alignItems: "center", gap: 4 }}>{saveStatus === "saving" ? "Saving\u2026" : saveStatus === "error" ? `Save failed \u2014 ${saveErrorMsg||"check connection"}` : "Saved \u2713"}</span>}
      </div>
      {projectSection !== "Home" && (
