...
import { Badge, Pill, StatCard, TH, TD, SearchBar, Sel, OutreachBadge, THFilter, SectionBtn, UploadZone, BtnPrimary, BtnSecondary, BtnExport, renderSopMarkdown, AIDocPanel, DashNotes, ProjectTodoList, LocationPicker } from "./components/ui/SharedUI";
...
function OnnaDashboardInner() {
  ...
  // ── Modal props bundle ──
  const _mp = {T, isMobile, api, BtnPrimary, BtnSecondary, Sel, OutreachBadge, StarIcon, LocationPicker,
